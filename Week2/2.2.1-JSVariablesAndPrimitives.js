...
console.log("Hello, my name is " + newName + ", and I am learning " + language + ". I have been practicing for only " +  numberWeek + " weeks, so my status as a master is: " + ourStatus + ".");
